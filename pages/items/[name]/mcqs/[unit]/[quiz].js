...
export default function Quiz() {
  ...
  return (
    ...
    objectFit="cover" className="absolute top-0"/>
        ...
        <div className=" w-full z-10 flex flex-col items-center text-white py-[3rem] px-4">
            <div className="flex space-x-5 justify-center w-full">
            <div className="rounded-md border border-[#FFFFFF] py-4 px-5">
                <h1>Total Time</h1>
                <p>{Math.floor(timer / 60)} Min {timer % 60}</p>
            </div>
            <div className="rounded-md bg-white w-[36%] flex justify-center  py-4 px-5">
                <Image src="/images/logo.svg" width={80} height={80} alt="logo"/>
            </div>
            <div className="rounded-md border border-[#FFFFFF] py-4 px-5 flex flex-col items-center">
            <h1>Skipped</h1>
                <p>{skippedQuestions}</p>
            </div>
            <div className="rounded-md border border-[#FFFFFF] py-4 px-5 flex flex-col items-end">
                <h1>Total MCQs</h1>
            ...
            <div className="bg-white w-[700px] rounded-lg text-black py-5 px-[1.5rem] my-[3rem] shadow-md ">
                ...
                <div className="my-6 mx-[2rem] font-[500] text-[18px]">
          ...
          <div
            ...
            className={`rounded-lg border border-[#268FDA47] py-3 px-3 flex items-center transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-md hover:bg-[#268FDA47] cursor-pointer ${
...
<div className="flex w-full justify-between my-4">
  ...
  <button onClick={handleNextQuestion} disabled={currentQuestionIndex === quizData.length - 1} className="bg-[#D7392B] py-2 px-5 rounded-md text-white font-[500] text-[18px] hover:bg-[#FF4D38] hover:shadow-md transition duration-300 ease-in-out">Next Que</button>
                ...
                <div className="bg-[#146B53] rounded-md py-4 px-4 flex justify-evenly mt-8">
